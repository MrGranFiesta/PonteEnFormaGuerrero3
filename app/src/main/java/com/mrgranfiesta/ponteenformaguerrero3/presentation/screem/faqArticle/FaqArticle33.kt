...
@Composable
fun FaqArticle33() {
    Text("La funcionalidad de estadísticas esta solo disponible para usuarios premium. En la pantalla de información de la estadística que se quiere borrar, pulsa el botón con forma de papelera.")
    Spacer(modifier = Modifier.height(8.dp))
    FAQImagenFromUri("${DRAWABLE_URI}man33_1".toUri())
    Spacer(modifier = Modifier.height(8.dp))
    Text("Aparecerá un diálogo de confirmación, pulsa en la opción “Si” para confirmar.")
    Spacer(modifier = Modifier.height(8.dp))
    FAQImagenFromUri("${DRAWABLE_URI}man33_2".toUri())
    Spacer(modifier = Modifier.height(8.dp))
}