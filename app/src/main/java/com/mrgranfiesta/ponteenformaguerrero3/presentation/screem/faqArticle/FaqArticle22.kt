...
@Composable
fun FaqArticle22() {
    Text("En la pantalla de información de la rutina que quiere borrar, pulsa el botón con forma de papelera.")
    Spacer(modifier = Modifier.height(8.dp))
    FAQImagenFromUri("${DRAWABLE_URI}man22_1".toUri())
    Spacer(modifier = Modifier.height(8.dp))
    Text("Aparecerá un diálogo de confirmación, pulsa en la opción “Si” para confirmar.")
    Spacer(modifier = Modifier.height(8.dp))
    FAQImagenFromUri("${DRAWABLE_URI}man22_2".toUri())
    Spacer(modifier = Modifier.height(8.dp))
}