...
@Composable
fun FaqArticle21() {
    Text("En la pantalla información de la rutinas que quiere editar, pulsa el botón con forma de lápiz.")
    Spacer(modifier = Modifier.height(8.dp))
    FAQImagenFromUri("${DRAWABLE_URI}man21_1".toUri())
    Spacer(modifier = Modifier.height(8.dp))
    Text("Rellena los datos del formulario. Pulsa el botón con forma de check para guardar los cambios.")
    Spacer(modifier = Modifier.height(8.dp))
    FAQImagenFromUri("${DRAWABLE_URI}man21_2".toUri())
    Spacer(modifier = Modifier.height(8.dp))
