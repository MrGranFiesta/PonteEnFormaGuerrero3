...
class FilterStatDialogVM : ViewModel() {
    ...
    private val _isInitDateModeCalendar = MutableStateFlow(false)
    val isInitDateModeCalendar: StateFlow<Boolean> = _isInitDateModeCalendar
    fun setInitDateModeCalendar(isInitDateModeCalendar: Boolean) {
        _isInitDateModeCalendar.value = isInitDateModeCalendar
    }

    private val _isEndDateModeCalendar = MutableStateFlow(false)
    val isEndDateModeCalendar: StateFlow<Boolean> = _isEndDateModeCalendar
    fun setEndDateModeCalendar(isEndDateModeCalendar: Boolean) {
        _isEndDateModeCalendar.value = isEndDateModeCalendar
    }
    ...
    fun onDismissDialog(dismissDialog: () -> Unit) {
        status = true
        dismissDialog()
    }
}