...
@Composable
fun FaqArticle23() {
    Text("En la pantalla principal de rutinas, pulsa la rutina que quiere visualizar.")
    Spacer(modifier = Modifier.height(8.dp))
    FAQImagenFromUri("${DRAWABLE_URI}man23_1".toUri())
    Spacer(modifier = Modifier.height(8.dp))
    Text("Se visualizará de la siguiente manera.")
    Spacer(modifier = Modifier.height(8.dp))
    FAQImagenFromUri("${DRAWABLE_URI}man23_2".toUri())
    Spacer(modifier = Modifier.height(8.dp))
}